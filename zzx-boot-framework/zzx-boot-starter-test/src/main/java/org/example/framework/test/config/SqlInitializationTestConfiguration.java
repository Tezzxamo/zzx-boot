package org.example.framework.test.config;
...
/**
 * SQL 初始化的测试 Configuration<br/><br/>
 * <p>
 * 为什么不使用 org.springframework.boot.autoconfigure.sql.init.DataSourceInitializationConfiguration 呢？<br/>
 * 因为我们在单元测试会使用 spring.main.lazy-initialization 为 true，开启延迟加载。此时，会导致 DataSourceInitializationConfiguration 初始化<br/>
